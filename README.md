...
⚙️ How It Works
The app retrieves the user’s current location using the Geolocation API.
Available places are sorted dynamically based on proximity.
Users can:
Select places to add to their list
Remove places with confirmation
All selected places are stored locally and reloaded on revisit.
🧠 Tech Stack
